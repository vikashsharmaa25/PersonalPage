      ...
      <div className="py-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
        ...
        >
          <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-7">
            ...
            <br />
            I have experience working with C, C++, JavaScript, HTML, CSS,
            React.js, Next.js, Node.js, Express.js, MongoDB, Tailwind CSS, and
            Git.
                ...
                >
                  ...
                  <div className="mt-2 flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span>
                        <p>
                          Integration services such as NodeJs / Firebase /
                          Socket
                        </p>
                      </span>
                    </div>
                  </div>
                  <div className="ml-6 mt-4 text-gray-500 font-medium flex items-center justify-between max-w-[95%]">
                    <span className="">Aug 2023 - Present</span>
